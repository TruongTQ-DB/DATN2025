...
import kotlinx.android.synthetic.main.item_the_new.view.*

class TheNewAdapter(context: Context) : EndlessLoadingRecyclerViewAdapter(context, false) {

    var onClick: (TheNewItem) -> Unit = {}
    override fun initNormalViewHolder(parent: ViewGroup): RecyclerView.ViewHolder? {
        return HistoryExaminationViewHolder(parent.inflate(R.layout.item_the_new))
    }
...
data class TheNewItem(var id: String, var data: TheNewRequest)