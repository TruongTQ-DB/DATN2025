...
class CustomTabLayoutView(context: Context, attrs: AttributeSet?) :
    ...
    override fun getLayoutRes(): Int {
        return R.layout.custom_tab_layout_view
    }
    ...
    fun setText(textLeft: String, textRight: String){
        tv_left.text = textLeft
        tv_right.text = textRight
    }
