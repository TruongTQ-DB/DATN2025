package com.graduate.datn.base.adapter
...
import com.graduate.datn.base.adapter.EndlessLoadingRecyclerViewAdapter.OnLoadingMoreListener
import com.graduate.datn.extension.ProjectColors
import com.graduate.datn.extension.color
...
class BaseRecyclerView : RelativeLayout {
    ...
    fun getRcyView(): RecyclerView? {
        return rcv_data
    }

    fun nestedScrollingEnabled(){
        rcv_data.isNestedScrollingEnabled = true
    }
