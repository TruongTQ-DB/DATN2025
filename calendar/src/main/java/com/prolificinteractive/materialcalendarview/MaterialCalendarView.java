...
//      );
  ...
  /**
   * Custom follow new design
   *
   *
   *
   */

  public class AbbreviatedWeekDayFormatter implements WeekDayFormatter {
    private final String[] WEEKDAY_ABBREVIATIONS = {"CN", "T2", "T3", "T4", "T5", "T6", "T7"};

    @Override
    public CharSequence format(DayOfWeek dayOfWeek) {
      return WEEKDAY_ABBREVIATIONS[dayOfWeek.getValue() % WEEKDAY_ABBREVIATIONS.length];
    }
  }

  public void setWeekDayFormatterNew() {
    AbbreviatedWeekDayFormatter formatter = new AbbreviatedWeekDayFormatter();
    adapter.setWeekDayFormatter(formatter == null ? WeekDayFormatter.DEFAULT : formatter);
  }

  public void setCurrentDate(String bookingDate) {
